...
USBD_ClassTypeDef USBD_CUSTOM_HID = { USBD_CUSTOM_HID_Init, USBD_CUSTOM_HID_DeInit, USBD_CUSTOM_HID_Setup,
NULL, /*EP0_TxSent*/
...
NULL,
  ...
  NULL,
#else
		USBD_CUSTOM_HID_GetHSCfgDesc, USBD_CUSTOM_HID_GetFSCfgDesc, USBD_CUSTOM_HID_GetOtherSpeedCfgDesc, USBD_CUSTOM_HID_GetDeviceQualifierDesc,
#endif /* USE_USBD_COMPOSITE  */
		};
...
static uint8_t USBD_CUSTOM_HID_DataOut(USBD_HandleTypeDef *pdev, uint8_t epnum) {
	...
	((USBD_CUSTOM_HID_ItfTypeDef*) pdev->pUserData[pdev->classId])->OutEvent(hhid->Report_buf[0], (uint8_t*) &hhid->Report_buf);
