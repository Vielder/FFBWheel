...
__ALIGN_BEGIN static uint8_t CUSTOM_HID_ReportDesc_FS[USBD_CUSTOM_HID_REPORT_DESC_SIZE] __ALIGN_END
		...
		0x05, 0x01, // USAGE_PAGE (Generic Desktop)
				...
				0x09, 0x22,           //  Usage (Effect Block Index)
				0x15, 0x01,           //   Logical Minimum (1)
				0x25, 0x14,           //   Logical Maximum (20)
				0x35, 0x01,           //   Physical Minimum (1)
				0x45, 0x14,           //   Physical Maximum (20)
				...
				0x0B, 0x01, 0, 0x0A, 0,  //          Usage (Ordinals: Instance 1)
				0x0B, 0x02, 0, 0x0A, 0,  //          Usage (Ordinals: Instance 2)
				0x26, 0x20, 0x4E, //          Logical Maximum (27000); 27000K RAM or ROM max.
				0x75, 0x10,           //          Report Size (16)
				0x95, 0x02,           //          Report Count (2)
				0x91, 0x02,           //          Output (Data,Var,Abs)
				...
				0x15, 0x00,           //   Logical Minimum (0)
				0x27, 0x20, 0x4E, 0, 0, //   Logical Maximum (32K)
				0x35, 0x00,           //   Physical Minimum (0)
				0x47, 0x20, 0x4E, 0, 0, //   Physical Maximum (32K)
				0x66, 0x03, 0x10,     //   Unit (1003h) (English Linear, Seconds)
				0x55, 0xFD,           //   Unit Exponent (FDh) (X10^-3 ==> Milisecond)
				0x75, 0x20,           //   Report Size (32)
				0x95, 0x01,           //   Report Count (1)
				...
				0xA1, 0x02, // COLLECTION (Logical)
				0x85, HID_ID_NEWEFREP, // REPORT_ID (17)
				0x09, 0x25, // USAGE (Effect Type)
				0xA1, 0x02, // COLLECTION (Logical)
				0x09, 0x26, // USAGE (26)
				0x09, 0x27, // USAGE (27)
				...
				0x15, 0x00, // LOGICAL_MINIMUM (00)
				0x27, 0x20, 0x4E, 0x00, 0x00, // LOGICAL_MAXIMUM (00 00 FF FF)
				0x35, 0x00, // PHYSICAL_MINIMUM (00)
				0x47, 0x20, 0x4E, 0x00, 0x00, // PHYSICAL_MAXIMUM (00 00 FF FF)
				...
				0xA1, 0x02, // COLLECTION (Logical)
				0x85, HID_ID_POOLREP, // REPORT_ID (19)
				0x09, 0x80, // USAGE (RAM Pool Size)
				0x75, 0x10, // REPORT_SIZE (10)
				0x95, 0x01, // REPORT_COUNT (01)
				0x15, 0x00, // LOGICAL_MINIMUM (00)
				0x35, 0x00, // PHYSICAL_MINIMUM (00)
				0x27, 0x20, 0x4E, 0x00, 0x00, // LOGICAL_MAXIMUM (00 00 69 78)
				0x47, 0x20, 0x4E, 0x00, 0x00, // PHYSICAL_MAXIMUM (00 00 69 78)
				0xB1, 0x02, // FEATURE (Data,Var,Abs)
...
static int8_t CUSTOM_HID_GetEvent_FS(USBD_SetupReqTypedef *req,
		uint8_t **return_buf);
...
static int8_t CUSTOM_HID_GetEvent_FS(USBD_SetupReqTypedef *req,
	...
	switch (event_idx) {
		case HID_ID_BLKLDREP:
			...
			*return_buf = callFfbOnPIDBlockLoad(handler);
			break;
		case HID_ID_POOLREP:
			//printf("Get Pool Report\n");
			*return_buf = callFfbOnPIDPool(handler);
			break;
		default:
			break;
	}
